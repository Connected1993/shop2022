...
--
-- Хост: 127.0.0.1
-- Время создания: Июл 13 2022 г., 21:16
...
INSERT INTO `users` (`idUsers`, `login`, `password`, `email`, `avatar`, `role`) VALUES
(2, 'Admin', '111', 'Dima@mail.ru', NULL, 1),
(3, 'Misha', 'fg343', 'Misha@mail.ru', NULL, NULL),
(4, 'Alex', '24gh542', 'Alex@mail.ru', NULL, NULL),
(5, 'Masha', 'ololo2222', 'Masha@mail.ru', NULL, NULL),
(6, 'Dasha', 'f12gdw3453/', 'Dasha@mail.ru', NULL, NULL);
